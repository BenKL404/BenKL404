...
### 🏢 [LK-FONDATION](https://github.com/BENLK404/lk-fondation)
*Plateforme d'entreprise et marque délivrant des services informatiques et logiciels professionnels.*

### 🏫 [Loky](https://github.com/BENLK404/loky)
*Application de bureau (Electron.js & PostgreSQL) pour la gestion scolaire avancée, incluant l'export de données multiformats.*

### 🎵 [LKM Player (Musio)](https://github.com/BENLK404/lkm-player)
*Lecteur audio mobile professionnel sous Flutter avec extraction de métadonnées et affichage des paroles.*
...
*Solution complète de gestion des ressources humaines (RH) avec modules de paie et libre-service.*
